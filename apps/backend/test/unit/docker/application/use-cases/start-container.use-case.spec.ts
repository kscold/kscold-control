...
import { StartContainerUseCase } from '@/docker/application/use-cases/start-container.use-case';
import {
...
describe('StartContainerUseCase', () => {
  ...
  describe('execute', () => {
    ...
    it('should throw ContainerNotFoundException if container not found', async () => {
      ...
      dockerClient.startContainer.mockRejectedValue(new Error('not found'));
